...
class NetworkMob extends Component {
    ...
    return (
      ...
      <div className="network-mob">
        ...
        <div className="mob-parent">
            ...
            <div style={{backgroundImage: `url(${alice_url})`}} className="mob-avatar net-avatar mob-div1">
               <div className="overlay">
                Blockchain Engineer, Fluidity
               </div>
            </div>
            <div style={{backgroundImage: `url(${mark_url})`}} className="mob-avatar net-avatar mob-div2">
               <div className="overlay">
                MasterCard Fintech Consultant
               </div>
            </div>
            <div style={{backgroundImage: `url(${siv_url})`}} className="mob-avatar net-avatar mob-div3">
               <div className="overlay">
                Founder Nanovert, Engineer
               </div>
            </div>
            <div style={{backgroundImage: `url(${mon_url})`}} className="mob-avatar net-avatar  mob-div4">
               <div className="overlay">
                Medical Physicist, UCL
               </div>
            </div>
            <div style={{backgroundImage: `url(${izzy_url})`}} className="mob-avatar net-avatar mob-div5">
               <div className="overlay">
                Imperial Computer Scientist, App Developer
               </div>
            </div>
            <div style={{backgroundImage: `url(${niall_url})`}} className="mob-avatar net-avatar mob-div6">
               <div className="overlay">
                Dyson Engineer
               </div>
            </div>
            <div style={{backgroundImage: `url(${sk_url})`}} className="mob-avatar net-avatar mob-div7">
               <div className="overlay">
                Finance & Econometrics Graduate
               </div>
            </div>
            <div style={{backgroundImage: `url(${andrew_url})`}} className="mob-avatar net-avatar mob-div8">
               <div className="overlay">
                DPhil Computer Vision, University of Oxford
               </div>
            </div>
            <div style={{backgroundImage: `url(${stef_url})`}} className="mob-avatar net-avatar mob-div9">
               <div className="overlay">
                MSc Econometrics, Cambridge
               </div>
            </div>
            <div style={{backgroundImage: `url(${theo_url})`}} className="mob-avatar net-avatar mob-div10">
               <div className="overlay">
                Data Analyst, JP Morgan
               </div>
            </div>
            <div style={{backgroundImage: `url(${khalid_url})`}} className="mob-avatar net-avatar mob-div11">
               <div className="overlay">
                Economics & Strategy, Imperial
               </div>
            </div>
            <div style={{backgroundImage: `url(${lili_url})`}} className="mob-avatar net-avatar mob-div12">
               <div className="overlay">
                DPhil Computer Vision, University of Oxford
               </div>
            </div>
            <div style={{backgroundImage: `url(${georgia_url})`}} className="mob-avatar net-avatar mob-div13">
               <div className="overlay">
                Senior Data Analyst, Tesco
               </div>
            </div>
            {/*<div style={{backgroundImage: `url(${siv_url})`}} className="mob-avatar net-avatar mob-div14">
               <div className="overlay">
                Founder Nanovert, Engineer
               </div>
            </div>*/}
            <div style={{backgroundImage: `url(${laura_url})`}} className="mob-avatar net-avatar mob-div15">
               <div className="overlay">
                Kubrick Data Scientist
               </div>
            </div>
            <div style={{backgroundImage: `url(${hamish_url})`}} className="mob-avatar net-avatar mob-div16">
               <div className="overlay">
                Oxford Engineer & Imperial Computer Scientist
               </div>
            </div>
            <div style={{backgroundImage: `url(${kai_url})`}} className="mob-avatar net-avatar mob-div17">
               <div className="overlay">
                Founder Cardea
               </div>
            </div>
            <div style={{backgroundImage: `url(${max_url})`}} className="mob-avatar net-avatar mob-div18">
               <div className="overlay">
                Data Scientist
               </div>
            </div>
            <div style={{backgroundImage: `url(${ben_url})`}} className="mob-avatar net-avatar mob-div19">
               <div className="overlay">
                Founder Changemakers, Medicine University of Oxford
               </div>
            </div>
            <div style={{backgroundImage: `url(${fred_url})`}} className="mob-avatar net-avatar mob-div20">
               <div className="overlay">
                Mako Operations Analyst
               </div>
            </div>
            <div className="mob-avatar net-avatar mob-div21" style={{backgroundImage: `url(${archie_url})`}}>
              <div className="overlay">
                Technical Lead, APJ
               </div>
            </div>
                <div style={{backgroundImage: `url(${kate_url})`}} className="mob-avatar net-avatar mob-div22">
               <div className="overlay">
                Seeker Engineer, MBDA
               </div>
            </div>
            <div style={{backgroundImage: `url(${cam_url})`}} className="mob-avatar net-avatar mob-div23">
               <div className="overlay">
                Calastone Client Manager
               </div>
            </div>
            <div style={{backgroundImage: `url(${dan_url})`}} className="mob-avatar net-avatar mob-div24">
               <div className="overlay">
                Founder, MyWorld
               </div>
            </div>
            <div style={{backgroundImage: `url(${hope_url})`}} className="mob-avatar net-avatar mob-div25">
               <div className="overlay">
                Deloitte Network Analyst
               </div>
            </div>
            <div style={{backgroundImage: `url(${angus_url})`}} className="mob-avatar net-avatar mob-div26">
               <div className="overlay">
                Data Scientist
               </div>
            </div>
            <div className="mob-avatar net-avatar  mob-div14" style={{backgroundImage: `url(${dave_url})`}}>
              <div className="overlay">
                Cundall Engineer
               </div>
            </div>
